  ...
  const tabs = [
    {
      ...
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path d="M8 8L16 16M16 8L8 16" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" opacity="0.3"/>
        </svg>
      ),
      description: ''
    },
          ...
          <div className="flex justify-around items-center py-3 px-4 w-full">
            {tabs.map((tab) => (
              ...
              >
                ...
                {/* アイコンコンテナ */}
                <div className={`relative z-10 w-7 h-7 flex items-center justify-center mb-1 transition-all duration-300 ${
                  activeTab === tab.id 
                ...
                {/* ラベル */}
                <div className={`text-xs font-semibold transition-all duration-300 relative z-10 ${
                  activeTab === tab.id 
